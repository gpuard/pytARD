...
class PMLPartition2D():
    ...
    def __init__(   self,
        ...
        self.dx = SimulationParameters.calculate_voxelization_step(simulation_parameters)
        self.dy = SimulationParameters.calculate_voxelization_step(simulation_parameters)
